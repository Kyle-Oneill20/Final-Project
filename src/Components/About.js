...
export default function About() {
      ...
      return <div>
            ...
            <div className='dogImage flexbox'>
                  <img className="dogPic content-center" src={Happy} alt="Happy dogs" />
            </div>
            ...
            <p className= 'text-center warning' >Please Note that we do not take any dogs that have history of human aggression, or have not been properly vaccinated. This is non negotiable and we will refuse you at the door in such cases.</p>
      </div>
